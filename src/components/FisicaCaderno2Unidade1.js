...
export default function FisicaCaderno2Unidade1() {
    return (
<>
<PrivateButtonAppBar position="fixed"/>
<Container className='containerVideo' sx={{ flexGrow: 1 }}>
     <div>
          <h1 className='nome'>Física • Caderno 2 • Unidade 1</h1>
     </div>
    ...
    }} controls  url='http://mundotrivium.com.br/videos/fisica_caderno2_unidade1.mp4' />
</Container>
</>
